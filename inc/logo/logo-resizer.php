...
function vw_sports_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_sports_logo_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_sports_logo_padding',array(
		'label'	=> __('Logo Padding','vw-sports'),
	...
	$wp_customize->add_setting('vw_sports_logo_margin',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_sports_logo_margin',array(
		'label'	=> __('Logo Margin','vw-sports'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-sports'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'vw-sports' ),
    ),
