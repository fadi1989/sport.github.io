              ...
              <div class="carousel-caption">
                <div class="slider-inner-box">
                  ...
                  <?php if( get_theme_mod('vw_sports_slider_content_hide_show',true) != ''){ ?>
                    <p class="mt-2 wow slideInLeft delay-1000" data-wow-duration="3s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_sports_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_sports_slider_excerpt_number','30')))); ?></p>
                  <?php }?>
