...
<div id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box p-3 mb-3 wow zoomInUp delay-1000" data-wow-duration="2s">
    <?php $vw_sports_theme_lay = get_theme_mod( 'vw_sports_blog_layout_option','Default');
    ...
    <?php }else if($vw_sports_theme_lay == 'Center'){ ?>
      <div class="service-text">
        ...
        <?php if( get_theme_mod( 'vw_sports_featured_image_hide_show',true) != '') { ?>
          <div class="box-image">
            <?php the_post_thumbnail(); ?>
          </div>
        <?php } ?>
    ...
    <?php }else if($vw_sports_theme_lay == 'Left'){ ?>
      <div class="service-text">
        <?php if( get_theme_mod( 'vw_sports_featured_image_hide_show',true) != '') { ?>
          <div class="box-image">
            <?php the_post_thumbnail(); ?>
